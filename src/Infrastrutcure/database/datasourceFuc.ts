...
export const dataSourceOptions: DataSourceOptions = {
    ...
    entities: [join(__dirname, '..', '..', 'Domain', 'entities','FUC', '*.entity.{ts,js}')],
    synchronize: true, // Es una buena práctica para producción tenerlo en false
...
export const dataSourceFUC = new DataSource(dataSourceOptions);
